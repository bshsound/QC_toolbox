...
%             ! X:\Meereskunde\Unterwasserschall\HDF5_Testdaten_Skripte\Skripte\Matlabskripte\QC_toolbox\libs\Wikilogin.bat
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SoundPressureinChamberEditFieldLabel = uilabel(app.ResultsPanel);
            ...
            app.SoundPressureinChamberEditField = uieditfield(app.ResultsPanel, 'numeric');
            app.SoundPressureinChamberEditField.Position = [191 63 100 22];

            % Create CalibrationFactordBEditFieldLabel
            app.CalibrationFactordBEditFieldLabel = uilabel(app.ResultsPanel);
            ...
            app.CalibrationFactordBEditField = uieditfield(app.ResultsPanel, 'numeric');
            app.CalibrationFactordBEditField.Position = [191 36 100 22];

            % Create linearCalibrationFactorEditFieldLabel
            app.linearCalibrationFactorEditFieldLabel = uilabel(app.ResultsPanel);
            ...
            app.linearCalibrationFactorEditField = uieditfield(app.ResultsPanel, 'numeric');
