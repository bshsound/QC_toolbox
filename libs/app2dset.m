...
if size(app.bsh_leq_spectro_temporal_values,1)<size(app.bsh_leq_spectro_temporal_values,2)
    app.bsh_leq_spectro_temporal_values = app.bsh_leq_spectro_temporal_values';
end
if size(app.bsh_reference_frequencies_levels) ~= [1,1]
    app.bsh_reference_frequencies_levels = string(['[' num2str(app.bsh_reference_frequencies_levels(1)) ' Hz, ' num2str(app.bsh_reference_frequencies_levels(2)) ' dB re 1 µPa]']);
end
    dset = struct(...
        'author', string(app.bsh_author), ...
        ...
        'dataset_ambient_noise', struct( ...
            'calibration', struct( ...
                ...
                'reference_frequencies_levels', num2str(app.bsh_reference_frequencies_levels)), ...
            ...
            'measurement_data', struct( ...
                ...
                'frequency_count', int16(app.bsh_frequency_count), ...
